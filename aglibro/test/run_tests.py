...
def run_reproduction_tests(
    ...
    results = {}
    for instance_id in resolved_dict:
        test_output_file = os.path.join("logs", "run_evaluation", run_id, split, instance_id, "test_output.txt")
        if os.path.exists(test_output_file):
            ...
            passes_tests = txt_file_contains_string(
                test_output_file, expected_output, other_patterns=other_patterns
            )
