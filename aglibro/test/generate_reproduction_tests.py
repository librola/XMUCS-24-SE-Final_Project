...
from aglibro.util.postprocess_data import remove_comments_and_docstrings
from aglibro.util.utils import load_jsonl, setup_logger
...
def normalize_tests(args):
    ...
    for i in selected_ids:
        ...
        for d in tests:
            test = extract_first_code_block(d["raw_test_patch"] if "raw_test_patch" in d else "")
