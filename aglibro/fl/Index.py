...
from aglibro.util.index_skeleton import parse_global_stmt_from_code
    ...
    def retrieve(self, mock=False):
        ...
        if not os.path.exists(persist_dir) or mock:
            ...
            if mock:
                ...
                embed_model = OpenAIEmbedding(model_name="text-embedding-3-small", api_base=os.environ.get("OPENAI_API_BASE") or os.environ.get("OPENAI_BASE_URL"))
