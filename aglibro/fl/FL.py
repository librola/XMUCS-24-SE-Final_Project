...
from aglibro.repair.repair import construct_topn_file_context
from aglibro.util.compress_file import get_skeleton
from aglibro.util.postprocess_data import extract_code_blocks, extract_locs_for_files
...
Please review the following GitHub problem description and relevant files, and provide a set of locations that need to be edited to fix the issue.
The locations can be specified as class or method that require modification.
