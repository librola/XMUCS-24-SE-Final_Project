...
from aglibro.fl.FL import LLMFL
...
from aglibro.util.utils import load_existing_instance_ids, load_jsonl, setup_logger
...
def localize_irrelevant_instance(
    ...
    if args.target_id is not None:
        if bug["instance_id"] not in args.target_id:
            return
