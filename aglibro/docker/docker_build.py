...
BASE_IMAGE_BUILD_DIR = Path("docker_images/base")
ENV_IMAGE_BUILD_DIR = Path("docker_images/env")
INSTANCE_IMAGE_BUILD_DIR = Path("docker_images/instances")
RUN_EVALUATION_LOG_DIR = Path("results/test_postprocess")
